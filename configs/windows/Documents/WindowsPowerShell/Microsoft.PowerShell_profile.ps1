# PowerShell profile — Windows post-install setup
# Generated 2026-04-26

# Shell identifier (read by starship.toml's env_var module to render the [ LABEL ] chip)
$env:STARSHIP_SHELL_LABEL = "PS-DEFAULT"

# Set terminal background (OSC 11) — dark royal blue
[Console]::Write([char]27 + "]11;#0a1a4d" + [char]7)

# Starship prompt (cross-shell parity with WSL zsh)
